...
// import img1 from './assets/Images/mountain.jpg';
// import img3 from './assets/Images/mountain2.jpeg';
// function App() {
//   return (
//     <>
...
//       <img src={img} class="d-block w-100"  width={200} height={200} alt="..."/>
//     </div>
//     <div class="carousel-item">
//       <img src={img1} class="d-block w-100"  width={200} height={200} alt="..."/>
//     </div>
//     <div class="carousel-item">
//       <img src={img3} class="d-block w-100"  width={200} height={200} alt="..."/>
//     </div>
//   </div>
...
//           <h5 className="card-title">Card details 1</h5>
...
//         <div className="card-body">
//           <h5 className="card-title">Card details 2</h5>
//           <p className="card-text">
//             Some quick example text to build on the card title and make up the bulk of the card’s content.
//           </p>
//           <a href="#" className="btn btn-primary">
...
//         <div className="card-body">
//           <h5 className="card-title">Card details 3</h5>
//           <p className="card-text">
//             Some quick example text to build on the card title and make up the bulk of the card’s content.
//           </p>
//           <a href="#" className="btn btn-primary">
